...
while( 1 ):
    ...
    # 計算買進金額
    BuyAmount = ClosePrice * BuyQuantity
    ...
    # print( '損益金額 : ', ( ClosePrice - HoldCost ) * HoldAmount )
    # print( '損益比例 : ', '{:.2%}'.format( ClosePrice / HoldCost - 1 ) )
    # print()
    oFrame.loc[ oFrameIndex ] = [ data[ data.columns[ 0 ][ 0 ],  '日期' ][ 0 ], ClosePrice, BuyQuantity, BuyAmount, HoldQuantity, HoldCost, HoldAmount , ( ClosePrice - HoldCost ) * HoldAmount, '{:.2%}'.format( ClosePrice / HoldCost - 1 ) ]
    oFrameIndex += 1
...
oFrame.to_excel( writer, sheet_name = TargetStockNo )
writer.save()
